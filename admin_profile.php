...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $dob    = $_POST['dob'];
    try {
        $pdo->prepare("UPDATE users SET phone=?, gender=?, dob=? WHERE id=?")->execute([$phone, $gender, $dob, $user_id]);
        $message = '<p class="msg-success">Profile updated successfully!</p>';
...
.btn-primary { padding:10px 22px; background:#2c3e50; color:#fff; border:none; border-radius:4px; cursor:pointer; font-family:inherit; font-size:13px; font-weight:500; margin-top:6px; }
